...
function Home() {
  ...
  const handleConsultar = () => {
    ...
    if (cpfNumeros.length !== 11) {
      setErroCpf('CPF inválido. Digite 11 números.');
      return;
    }
    setErroCpf('');
    navigate(`/cadastro?cpf=${cpfNumeros}`);
  };
          ...
          <div className="flex flex-col gap-4 items-center justify-center py-2">
            ...
            <div className="flex flex-col items-center gap-2 w-full max-w-md">
              ...
              <button
                ...
                className="rounded-full text-black bg-orange-400 hover:bg-orange-500 hover:text-orange-200 transition-all duration-300 cursor-pointer border-none py-3 px-6 w-150 mt-2 text-lg font-bold"
              >
                Consultar meu CPF grátis
              </button>
            </div>
          </div>
